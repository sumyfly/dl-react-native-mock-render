...
_DeviceEventEmitter2['default'].removeListener('keyboardWillShow',this.scrollResponderKeyboardWillShow);
_DeviceEventEmitter2['default'].removeListener('keyboardWillHide',this.scrollResponderKeyboardWillHide);
_DeviceEventEmitter2['default'].removeListener('keyboardDidShow',this.scrollResponderKeyboardDidShow);
_DeviceEventEmitter2['default'].removeListener('keyboardDidHide',this.scrollResponderKeyboardDidHide);
